...
/* ═══════════════════════════════════════════
   SCALED CERTIFICATE (RESPONSIVE WRAPPER)
   ═══════════════════════════════════════════ */
function ScaledCertificate({ children, innerRef }) {
  ...
  const updateScale = useCallback(() => {
    ...
    const availH = wrapperRef.current.offsetHeight;
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* ── TITLE ── */}
          <h1 style={{
            fontFamily: FF, fontSize: 84, fontWeight: 800,
          ...
          <div style={{ margin: '28px 0' }}><Divider w={420} /></div>

          {/* ── VERSE ── */}
          <p style={{
            fontFamily: FB, fontStyle: 'italic', fontSize: 28,
            color: C.textSoft, textAlign: 'justify', maxWidth: 920,
            lineHeight: 1.5, margin: '1 0 12px',
          }}>
          ...
          {/* Church name */}
          <p style={{
            fontFamily: FB, fontSize: 36, color: C.textMid,
            textAlign: 'center', margin: '0 0 16px', lineHeight: 1.4,
          }}>

            <span style={{
              fontFamily: FF, fontWeight: 700, fontSize: 42,
              color: C.blueDark, letterSpacing: 5,
            }}>
          ...
          {/* Member name */}
          <div style={{ textAlign: 'center', marginBottom: 10, width: '70%' }}>
            <p style={{
              fontFamily: FF, fontSize: 56, fontWeight: 800,
              color: C.blueDark, letterSpacing: 5,
          ...
          {/* Paragraph */}
          <p style={{
            fontFamily: FB, fontSize: 32, color: C.textMid,
            textAlign: 'center', lineHeight: 1.7, maxWidth: 960,
          }}>
            ...
            Filho e do Espírito Santo no dia{' '}
          ...
          {/* ── SIGNATURES & LOGO ── */}
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 60, width: '100%', marginTop: 150 }}>
            <div style={{ textAlign: 'center', width: 260 }}>
              <div style={{ height: 1.5, background: `linear-gradient(90deg, transparent, ${C.textSoft}, transparent)`, marginBottom: 8 }} />
              <span style={{ fontFamily: FF, fontSize: 24, color: C.textSoft, letterSpacing: 3, textTransform: 'uppercase' }}>
                Secretário(a)
              </span>
            </div>

            <img src={logoIbbi} alt="IBBI" style={{ width: 65, height: 65, borderRadius: '50%', objectFit: 'cover', border: `2.5px solid ${C.gold}`, flexShrink: 0, opacity: 0.95 }} />
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* ── TITLE ── */}
        <h1 style={{
          fontFamily: FF, fontSize: 62, fontWeight: 700,
          color: C.blueDark, letterSpacing: 10,
          textTransform: 'uppercase', margin: '0 0 5px', textAlign: 'center',
        }}>
          PACTO DAS IGREJAS BATISTAS
        </h1>

        <div style={{ margin: '0 0 18px' }}><Divider w={380} /></div>

        {/* ── INTRO (bold) ── */}
        <p style={{
          fontFamily: FB, fontWeight: 700, fontSize: 24,
          color: C.text, textAlign: 'justify', maxWidth: 1300,
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'center' }}>
          <p style={{
            fontFamily: FB, fontSize: 25, color: C.textMid,
            textAlign: 'justify', lineHeight: 1.7, maxWidth: 1380, margin: 0,
          }}>
        ...
        <div style={{
          ...
          gap: 16, marginTop: 8, paddingTop: 8,
          ...
          <div>
            ...
            <p style={{
              ...
              color: C.textSoft, margin: '6px 0 0',
            }}>
    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-4 bg-black/60 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-4 sm:px-8 py-5 sm:py-6 flex flex-col items-center gap-5">
          ...
          <div className="inline-flex bg-slate-100 rounded-xl p-1.5 gap-1">
            {[{ key: 'front', label: 'Frente' }, { key: 'back', label: 'Verso' }].map(t => (
              <button
                ...
                className={`px-6 py-2.5 rounded-lg text-sm font-semibold transition-all ${side === t.key
          ...
          <div className="relative w-full rounded-2xl border border-slate-100 bg-slate-50/50 flex justify-center">
            <ScaledCertificate>
